        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-slate-600">Déjà inscrit ?</span>
              <Link 
                href="/connexion"
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex items-center justify-center">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center">
                ...
                {s < 3 && (
                  <div className={`w-24 h-1 mx-2 rounded ${step > s ? 'bg-blue-600' : 'bg-slate-200'}`} />
                )}
              </div>
            ))}
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                          errors.agencyName ? 'border-red-500' : 'border-slate-300'
                        }`}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                          errors.agencyAddress ? 'border-red-500' : 'border-slate-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                        errors.agencyPostalCode ? 'border-red-500' : 'border-slate-300'
                      }`}
                      placeholder="75008"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                        errors.agencyCity ? 'border-red-500' : 'border-slate-300'
                      }`}
                      placeholder="Paris"
                    />
                    {errors.agencyCity && (
            ...
            <div className="px-8 py-6 bg-slate-50 border-t border-slate-200 flex justify-between">
              ...
              {step < 3 ? (
                <button
                  type="button"
                  onClick={nextStep}
                  className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all"
                >
                  Continuer
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200">
            ...
            <div>
              <h4 className="font-semibold text-slate-900">Données sécurisées</h4>
              <p className="text-sm text-slate-500">Chiffrement SSL 256-bit</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200">
            ...
            <div>
              <h4 className="font-semibold text-slate-900">Activation immédiate</h4>
              <p className="text-sm text-slate-500">Commencez en 2 minutes</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200">
            ...
            <div>
              <h4 className="font-semibold text-slate-900">+1 500 agences</h4>
